        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-group border-0">
                    ...
                    <li class="list-group-item border-0">
                        <a href="<?= BASEURL ?>/Profile/Dibatalkan" class="text-decoration-none fs-5 fw-medium active-profile">Pembatalan</a>
                    </li>
                </ul>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($data['tagihan'] as $rental) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= BASEURL; ?>/Profile/deleteRental" method="post" id="orderForm">
                                                <input type="hidden" name="rental_id" value="<?= $rental['rental_id'] ?>">
