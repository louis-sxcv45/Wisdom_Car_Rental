        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-group border-0">
                    ...
                    <h4>Pesanan</h4>
                    <li class="list-group-item border-0">
                        <a href="<?= BASEURL ?>/Profile/Tagihan" class="text-decoration-none fs-5 fw-medium active-profile">Tagihan</a>
                    </li>
                    <li class="list-group-item border-0">
                            ...
                            <tbody>
                                <?php foreach ($data['tagihan'] as $rental) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= BASEURL ?>/profile/cancelRental/<?= $rental['rental_id']; ?>" method="POST">
                                                <button type="submit" class="btn btn-danger">Cancel</button>
                                            </form>
                                            <form action="<?= BASEURL; ?>/Profile/bayar" method="post" id="orderForm">
